...
const Navbar = () => {
  return (
    <>
      <div className='flex justify-between max-sm:items-center px-40  max-sm:px-8 max-sm:py-4 py-8 max-xl:px-8 font-semibold max-sm:shadow-sm max-sm:fixed max-sm:top-0 max-sm:z-10 max-xl:text-sm bg-orange-400 font-poppins max-xl:w-screen max-sm:w-full'>
        <h1 className='text-2xl max-xl:text-lg font-sans text-white border-l-2 rounded-2xl p-1 max-sm:text-sm'>DreamSpace.</h1>
        <div className='flex justify-between items-center gap-10 max-xl:gap-4  max-sm:hidden'>
          ...
          <Link to="/interiorproducts" className='text-orange-100 hover:text-white border-x border-orange-300 rounded-xl p-1 px-2 hover:border-orange-500 hover:shadow hover:shadow-slate-200'>Shop</Link>
          ...
          <p className='text-orange-100 hover:text-white border-x border-orange-300 rounded-xl p-1 px-2 hover:border-orange-500 hover:shadow hover:shadow-slate-200'>Contact</p>
