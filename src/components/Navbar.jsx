    ...
    <>
      <div className='flex justify-between max-sm:items-center px-40  max-sm:px-8 max-sm:py-4 py-8 max-xl:px-8 font-semibold max-sm:shadow-sm max-sm:fixed max-sm:top-0 max-sm:z-10 max-xl:text-sm bg-orange-400 font-sora max-xl:w-screen max-sm:w-screen'>
        ...
        <div className='flex justify-between text-sm items-center gap-10 max-xl:gap-4'>
          <Link to="/" className='text-orange-100 hover:text-white border-x border-orange-300 rounded-xl p-1 px-2 hover:border-orange-500 shadow shadow-slate-200 cursor-pointer'>Home</Link>
          ...
          <p className='text-orange-100 hover:text-white border-orange-300 rounded-xl p-1 px-2 hover:border-orange-500 hover:shadow hover:shadow-slate-200 cursor-pointer'>Services</p>
          <p className='text-orange-100 hover:text-white border-orange-300 rounded-xl p-1 px-2 hover:border-orange-500 hover:shadow hover:shadow-slate-200 cursor-pointer'>Blog</p>
          ...
          <FaUser title='Profile' className='size-4 cursor-pointer'/>
         <Link to="/cart"> <FaCartPlus title='Cart' className='size-4 cursor-pointer'/></Link>
        </div>
