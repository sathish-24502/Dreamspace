...
const Navbar = () => {
  return (
    <>
      <div className='flex justify-between max-sm:items-center px-40 max-sm:px-8 max-sm:py-4 py-8 max-xl:px-10 font-semibold max-sm:shadow-sm max-sm:fixed max-sm:top-0 max-sm:z-10 max-xl:w-screen bg-orange-400 font-poppins max-sm:w-full'>
        <h1 className='text-2xl font-sans text-white border-l-2 rounded-2xl p-1 max-sm:text-sm'>DreamSpace.</h1>
        <div className='flex justify-between items-center gap-10 max-xl:gap-6  max-sm:hidden'>
