  ...
  return (
    <div className="flex max-sm:flex-col justify-around items-center font-poppins mx-4 my-20 max-sm:my-4">
      <span className="grid gap-3 max-sm:gap-2">
        ...
        <p className="size-72 h-44  max-sm:text-xs">
        ...
        <button className=" w-44 py-3 max-sm:h-10 max-sm:w-16 max-sm:rounded-2xl max-sm:text-xs rounded-full hover:border-orange-600 hover:shadow-sm hover:shadow-black bg-orange-300 max-sm:-mt-12">
          Explore
        </button>
      </span>
      <div className="flex max-sm:flex-col max-sm:gap-4 max-sm:py-8">
        <span className="grid gap-2 justify-center items-center p-4 rounded-md">
          <img
            src={product1}
            alt="product-1"
            className="size-64 max-sm:size-44 hover:-translate-y-10 duration-500 hover:duration-500"
          />
