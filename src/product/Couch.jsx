  ...
  return (
    <>
      <span className="flex justify-center items-center max-sm:m-4">
        <h1 className="text-3xl text-gray-700 font-bold mx-10 py-6 max-sm:text-xl max-sm:mx-0 max-sm:py-16">
          PRODUCTS
        </h1>
      </span>
      <div className="px-10 py-4 font-poppins max-sm:px-2">
        <span>
          <h1 className="text-4xl py-4 font-bold text-gray-700 max-sm:text-lg max-sm:-mt-24 max-xl:text-2xl">
            Where Comfort Meets Family Living ...
          </h1>
        </span>
        {SofaAD.map((SofaAD, index) => (
          <div className="flex justify-center items-center gap-10 max-sm:flex-col max-sm:gap-4">
            <img
              ...
              src={SofaAD.imageAD}
              alt="sofaAdImage"
              className="w-1/3 h-1/3 rounded-3xl max-sm:w-96 max-sm:rounded-md"
            />
            <span className="grid gap-6 max-sm:gap-2">
              <h1 className="text-3xl font-semibold text-gray-600 max-sm:text-lg max-xl:text-2xl">
                {SofaAD.title}
              </h1>
              <p className="w-3/4 text-lg max-sm:text-xs max-sm:w-5/6 max-xl:w-96">
                {SofaAD.desc}
              </p>
            </span>
          </div>
        ...
        {Sofa.map((Sofa, index) => (
          <div className="grid gap-2">
            <img
              ...
              src={Sofa.image}
              alt="SofaImages"
              className="w-80 h-64 rounded-xl border border-orange-100 shadow-md max-sm:w-72"
            />
